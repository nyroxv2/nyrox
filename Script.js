...
document.addEventListener("DOMContentLoaded", () => {
    ...
    /* =================================================
       BACK / BFCache BUTTON RESET
       Fixes buttons staying on "Loading..." / "Opening..."
       after returning with the browser Back button.
       Does NOT touch dashboard/storage logic.
    ================================================= */
    ...
    function resetNavigationButtons() {
        ...
        document.querySelectorAll(".challenge-btn").forEach(button => {
            ...
            button.innerText = button.dataset.originalText || "Open";
        });
    ...
    challengeButtons.forEach(button => {
        if (!button.dataset.originalText) {
            button.dataset.originalText = button.innerText.trim() || "Open";
        }
